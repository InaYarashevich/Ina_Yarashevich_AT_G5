...
public class TrainMethodsPrimitiveRunner {
    ...
    public static void main(String[] args) {
        ...
        trainMethodsPrimitive.printByte((byte) 7);
        trainMethodsPrimitive.printChar('a');
        trainMethodsPrimitive.printDouble(2122.13d);
        trainMethodsPrimitive.printFloat(3.14f);
        trainMethodsPrimitive.printLong(87430345L);
        trainMethodsPrimitive.printInt(123);
